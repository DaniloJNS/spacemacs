...
(yas-define-snippets 'emacs-lisp-mode
                     '(("newp" "(defun `(spacemacs/get-parent-dir)`/init-${2:package-name} ()\n  ${3:(use-package $2\n  ${4::defer t\n  }${5::init\n  ${;; This block executes before the package has been loaded}\n  }${:config\n  ${;; This block executes after the package has been loaded}\n  })})\n$0" "new-package" nil nil nil "/home/danilo/.emacs.d/layers/+completion/auto-completion/local/snippets/emacs-lisp-mode/new-package" "direct-keybinding" nil)
                       ("micro" "(spacemacs|define-micro-state ${1:micro-state-name}\n    ${2::doc (spacemacs//$1-ms-documentation)}\n    ${3::use-minibuffer t}\n    ${4::evil-leader \"${5:Leader-key}\"}\n    :bindings\n    ${}\n    )" "micro-state" nil nil nil "/home/danilo/.emacs.d/layers/+completion/auto-completion/local/snippets/emacs-lisp-mode/micro-state" "direct-keybinding" nil)))
